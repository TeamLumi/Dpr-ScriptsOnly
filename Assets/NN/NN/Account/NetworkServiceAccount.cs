...
namespace nn.account
{
    public static partial class Account
    {
...
#else
        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_Initialize")]
        public static extern void Initialize();

#if NN_ACCOUNT_OPENUSER_ENABLE
        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_OpenUser")]
        public static extern Result OpenUser(ref UserHandle pOutHandle, Uid user);
#endif

        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_TryOpenPreselectedUser")]
        [return: MarshalAs(UnmanagedType.U1)]
        public static extern bool TryOpenPreselectedUser(ref UserHandle pOutHandle);

        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_ListQualifiedUsers")]
        public static extern Result ListQualifiedUsers(ref int pOutActualLength, Uid[] outUsers, int arrayLength);

        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_CloseUser")]
        public static extern void CloseUser(UserHandle handle);

        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_GetUserId")]
        ...
        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_StoreSaveDataThumbnailImage")]
        private static extern Result StoreSaveDataThumbnailImage(Uid user, byte[] imageBuffer, long imageBufferSize);

        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_DeleteSaveDataThumbnailImage")]
    ...
    public static partial class NetworkServiceAccount
    {
...
#else
        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_EnsureNetworkServiceAccountAvailable")]
        public static extern Result EnsureAvailable(UserHandle handle);

        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_IsNetworkServiceAccountAvailable")]
        public static extern Result IsAvailable([MarshalAs(UnmanagedType.U1)] ref bool pOut, UserHandle handle);

        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_GetNetworkServiceAccountId")]
        ...
        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_EnsureNetworkServiceAccountIdTokenCacheAsync")]
        ...
        [DllImport(Nn.DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_account_LoadNetworkServiceAccountIdTokenCache")]
